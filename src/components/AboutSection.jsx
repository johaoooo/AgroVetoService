      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-20">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight">
              Une Expertise Reconnue au Service du <span className="text-emerald-700">Congo</span>
            </h2>
            ...
            {/* Mot de la Direction en bloc citation */}
            <div className="relative p-6 sm:p-7 rounded-3xl bg-slate-50 border border-slate-200 mt-6 shadow-xs">
              <Quote className="w-10 h-10 text-emerald-500/20 absolute top-4 right-4" />
        ...
        <div className="space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* Missions */}
            <div className="rounded-3xl bg-emerald-50 border border-emerald-200/80 p-8 shadow-lg flex flex-col justify-between">
              <div className="space-y-4">
                <div className="w-12 h-12 rounded-2xl bg-emerald-600 text-white flex items-center justify-center">
                  <Target className="w-6 h-6" />
                </div>
                <h3 className="text-2xl font-extrabold text-emerald-950">NOS MISSIONS</h3>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {FOUNDER_DATA.values.map((val, idx) => (
                <div 
                  key={idx}
                  className="p-6 rounded-2xl bg-white border border-slate-200 shadow-md hover:border-emerald-500/40 transition-colors"
                >
                  <div className="w-10 h-10 rounded-xl bg-emerald-50 text-emerald-700 flex items-center justify-center font-black text-sm mb-3">
                    0{idx + 1}
                  </div>
