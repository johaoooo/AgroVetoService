      ...
      <div className="bg-slate-900 text-white py-14 border-b border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-3">
          <span className="text-xs font-bold text-sky-400 uppercase tracking-widest block">
            Soins Médicaux & Suivi Zootechnique
          </span>
          <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight">
            Clinique Vétérinaire & Pharmacie AVS
          </h1>
          <p className="text-slate-300 text-sm sm:text-base max-w-2xl mx-auto">
            Soins préventifs et curatifs pour animaux de compagnie, cheptels avicoles et élevages fermiers à Pointe-Noire.
          </p>
        </div>
      </div>
